# reference from https://github.com/CVL-UESTC/PFT-SR/blob/master/basicsr/models/pft_model.py
import torch

from basicsr.utils.registry import MODEL_REGISTRY
from .upsampler_model import UpsamplerModel
import torch.nn.functional as F

@MODEL_REGISTRY.register()
class PFTModel(UpsamplerModel):
